...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Aplikasi Cuaca Kelompok 4"),
      ),
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(18.0),
                  child: Text(
                    provider?.cuacaModel?.name ?? "Menunggu Data",
                    style: TextStyle(
                      fontSize: 20,
                ...
                Text(
                    provider.cuacaModel.weather?.first?.main ?? "Menunggu data"),
                SizedBox(
                  width: 200,
                  height: 200,
                  child: Image.network(
                ...
                Text("Temperatur : ${provider.cuacaModel.main?.temp} Celcius"),
              ],
            ),
          );
        },
